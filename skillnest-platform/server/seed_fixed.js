...
const importData = async () => {
  try {
    ...
    // Drop indices to avoid conflicts
    console.log('Dropping indices...');
    try {
      await User.collection.dropIndexes();
    } catch (err) {
      console.log('No user indices to drop or already removed');
    }
    try {
      await Course.collection.dropIndexes();
    } catch (err) {
      console.log('No course indices to drop or already removed');
    }
    ...
    console.log('Creating admin user and sample courses...');
